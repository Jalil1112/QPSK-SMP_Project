...
class qpsk_stage6(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._variable_qtgui_label_0_tool_bar.addWidget(Qt.QLabel("Number_Sync"))
        ...
        self.qtgui_number_sink_1.set_title("Position")
        ...
        self.qtgui_number_sink_0.set_title("MAX")
        ...
        for c in range(0, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.fft_vxx_1 = fft.fft_vcc(fftgr, False, [], True, 1)
        self.fft_vxx_0_0 = fft.fft_vfc(fftgr, True, [], True, 1)
        self.fft_vxx_0 = fft.fft_vfc(fftgr, True, [], True, 1)
        ...
        self.digital_glfsr_source_x_0 = digital.glfsr_source_b(d, True, 0, 1)
        ...
        self.blocks_stream_to_vector_1 = blocks.stream_to_vector(gr.sizeof_float*1, fftgr)
        self.blocks_stream_to_vector_0 = blocks.stream_to_vector(gr.sizeof_float*1, fftgr)
        self.blocks_stream_mux_0 = blocks.stream_mux(gr.sizeof_char*1, (seqlen, 1))
        self.blocks_pack_k_bits_bb_0_0 = blocks.pack_k_bits_bb(8)
        self.blocks_null_sink_0 = blocks.null_sink(gr.sizeof_short*1)
        self.blocks_multiply_const_xx_0 = blocks.multiply_const_ff(1/fftgr, fftgr)
        self.blocks_multiply_conjugate_cc_0 = blocks.multiply_conjugate_cc(fftgr)
        self.blocks_max_xx_0 = blocks.max_ff(fftgr, 1)
        self.blocks_delay_0_0 = blocks.delay(gr.sizeof_float*1, int(delay))
        self.blocks_complex_to_real_0 = blocks.complex_to_real(fftgr)
        self.blocks_char_to_float_0_1 = blocks.char_to_float(1, 1.0)
        self.blocks_char_to_float_0 = blocks.char_to_float(1, 1.0)
        self.blocks_argmax_xx_0_0 = blocks.argmax_fs(fftgr)
        self.blocks_abs_xx_0 = blocks.abs_ff(fftgr)
        ...
        self.connect((self.blocks_abs_xx_0, 0), (self.blocks_argmax_xx_0_0, 0))
        self.connect((self.blocks_abs_xx_0, 0), (self.blocks_max_xx_0, 0))
        self.connect((self.blocks_abs_xx_0, 0), (self.qtgui_vector_sink_f_0, 0))
        self.connect((self.blocks_argmax_xx_0_0, 1), (self.blocks_null_sink_0, 0))
        self.connect((self.blocks_argmax_xx_0_0, 0), (self.qtgui_number_sink_1, 0))
        ...
        self.connect((self.blocks_char_to_float_0_1, 0), (self.blocks_delay_0_0, 0))
        self.connect((self.blocks_char_to_float_0_1, 0), (self.blocks_stream_to_vector_1, 0))
        self.connect((self.blocks_complex_to_real_0, 0), (self.blocks_multiply_const_xx_0, 0))
        self.connect((self.blocks_delay_0_0, 0), (self.qtgui_time_sink_x_0_0, 1))
        self.connect((self.blocks_max_xx_0, 0), (self.qtgui_number_sink_0, 0))
        self.connect((self.blocks_multiply_conjugate_cc_0, 0), (self.fft_vxx_1, 0))
        self.connect((self.blocks_multiply_const_xx_0, 0), (self.blocks_abs_xx_0, 0))
        self.connect((self.blocks_pack_k_bits_bb_0_0, 0), (self.digital_constellation_modulator_0, 0))
        self.connect((self.blocks_stream_mux_0, 0), (self.blocks_pack_k_bits_bb_0_0, 0))
        self.connect((self.blocks_stream_mux_0, 0), (self.digital_map_bb_0_0_0_0, 0))
        ...
        self.connect((self.blocks_unpack_k_bits_bb_1, 0), (self.digital_map_bb_0_0_0, 0))
        ...
        self.connect((self.digital_glfsr_source_x_0, 0), (self.blocks_stream_mux_0, 0))
        self.connect((self.digital_linear_equalizer_0, 0), (self.digital_costas_loop_cc_0, 0))
        self.connect((self.digital_map_bb_0, 0), (self.blocks_unpack_k_bits_bb_1, 0))
        self.connect((self.digital_map_bb_0_0_0, 0), (self.blocks_char_to_float_0, 0))
        self.connect((self.digital_map_bb_0_0_0_0, 0), (self.blocks_char_to_float_0_1, 0))
        ...
        self.connect((self.fft_vxx_1, 0), (self.blocks_complex_to_real_0, 0))
    ...
    def set_d(self, d):
        self.d = d
        self.set_fftgr(2**self.d)
        self.set_seqlen((2**self.d)-1)
    ...
    def set_fftgr(self, fftgr):
        self.fftgr = fftgr
        self.blocks_multiply_const_xx_0.set_k(1/self.fftgr)
